...
describe('Service Tests', () => {
    ...
    describe('NucleoEtapaSubtipoProcesso Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(NucleoEtapaSubtipoProcessoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/nucleo-etapa-subtipo-processos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return NucleoEtapaSubtipoProcesso', () => {
