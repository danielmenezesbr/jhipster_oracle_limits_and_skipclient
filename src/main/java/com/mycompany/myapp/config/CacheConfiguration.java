...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.NucleoEtapaSubtipoProcesso.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.SubtipoProcesso.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.ABC.class.getName(), jcacheConfiguration);
